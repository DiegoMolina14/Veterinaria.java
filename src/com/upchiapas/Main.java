...
public class
    ...
    public static void main(String[] args) {
        System.out.println("Bienvenido a la Veteniraia de confianza");
            ...
            switch (opc) {
                ...
                case 7:
                    for (Mascota masco : Mascota.listaPets) {
                        ...
                        System.out.println("Especie " + masco.getEspecie());
                    }
                ...
                case 8:
                    ...
                    if (listaCompraPro.size() > 0 || listaCompraSer.size() > 0) {
                        ...
                        System.out.println("Ingrese con cuanto paga");
                        ...
                        if (pago < total) {
                            ...
                            System.out.println("Gracias poor su compra Hasta Luego");
                        }
                    } else {
            ...
            case 2:
                if (Servicios.listServicios.size() > 0) {
                    for (Servicios servi : Servicios.listServicios) {
                        ...
                        System.out.println(
                                "Nombre del Servicio" + servi.getNombreServicio()
                        );
